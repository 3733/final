        ...
        if (path != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (i + 1 < length) {
                    ...
                    if (!(node2.getNodeID().equals("BLANK")) && !(node.getNodeID().equals("BLANK"))) {
                        MoveTo to = new MoveTo(node.getxCoordinate() / data.divisionCst + data.offset, node.getyCoordinate() / data.divisionCst + data.offset);
                        LineTo toLine = new LineTo(node2.getxCoordinate() / data.divisionCst + data.offset, node2.getyCoordinate() / data.divisionCst + data.offset);
            ...
            animationPath.setStroke(Color.rgb(26,71,154));
            ...
            Circle rectangle = new Circle(3, 0,3);
